...
<html>
<head>
    <title>Registro de Usuario Login y Cambio de Contraseña</title>
    <link rel="stylesheet" href="style.css" type="text/css" media="all" />
    <link rel="stylesheet" href="//fonts.googleapis.com/css?family=Roboto:400,100,300,500,700,900" 	type="text/css" media="all">
</head>
<body>
    <h1>Registro de Usuario, Login y Cambio de Contraseña</h1>
	<div class="container">
        <?php
        ...
        <?php }else{ ?>
		<a href="" align="center"><h2>Inicia sesión o regístrate en segundos</h2></a>
